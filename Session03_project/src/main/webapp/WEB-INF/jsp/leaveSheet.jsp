    ...
    <div class="pages" id="pages">
        <div id="frame">
            <table>
                ...
                <c:forEach items="${leaverequestList}" var="m" varStatus="i">
                    <tr class="my_row">
                        <td>${i.count}</td>
                        <td>${m.l_proposer}</td>
                        ...
                        <td>
                            ...
                            <c:if test="${m.l_approve == 2}"><span style="color: purple">未通过审核</span></c:if>
                        </td>
                ...
                <tr>
                    <td colspan="7" style="text-align: left">
                        <input type="button" value="申请休假" onclick="askForLeave()">
                    </td>
                </tr>
            </table>
        </div>
